(function(app)
{
    ...
    function onHsSelect(e)
    {
        ...
        mainHsDiv.find(".dropdownList").find('.current').html($(mainHsDiv.find(".dropdownList li")[listItemId]).html());      
        setTimeout(function(){
    ...
    {
        addPolite();
        var mainDiv = $(e.currentTarget).closest(".imageBoxHolder");
        mainDiv.find('.containerImg').hide();
        listItemId = $(e.currentTarget).attr("data-id");
